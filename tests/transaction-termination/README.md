...
2026-09-08，macOS ARM64、Rust 1.94.1、Node.js v24.20.0：上述四组真实 release binary 测试通过。修复基线为 `04e275b`；构建产物 SHA-256：

```text
c9b5a07988a326866caee888e09726b989a02f4fa87b3b0a3720885c087ed6d2
```
